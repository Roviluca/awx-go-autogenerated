...
type Body60 struct {
	...
	AWX_RESOURCE_PROFILING_CPU_POLL_INTERVAL float64 `json:"AWX_RESOURCE_PROFILING_CPU_POLL_INTERVAL,omitempty"`
	...
	AWX_RESOURCE_PROFILING_MEMORY_POLL_INTERVAL float64 `json:"AWX_RESOURCE_PROFILING_MEMORY_POLL_INTERVAL,omitempty"`
	// Interval (in seconds) between polls for PID count. Setting this lower than the default will affect playbook performance.
	AWX_RESOURCE_PROFILING_PID_POLL_INTERVAL float64 `json:"AWX_RESOURCE_PROFILING_PID_POLL_INTERVAL,omitempty"`
