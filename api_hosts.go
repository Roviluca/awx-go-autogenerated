 ...
 * @param optional nil or *HostsApiHostsHostsGroupsCreateOpts - Optional Parameters:
     * @param "Data" (optional.Interface of interface{}) - 
...
func (a *HostsApiService) HostsHostsGroupsCreate(ctx context.Context, id string, localVarOptionals *HostsApiHostsHostsGroupsCreateOpts) (*http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.Data.IsSet() {
		...
		localVarOptionalData, localVarOptionalDataok := localVarOptionals.Data.Value().(interface{})
		if !localVarOptionalDataok {
				return nil, reportError("data should be interface{}")
		}
		localVarPostBody = &localVarOptionalData
	}
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
...
/* 
HostsApiService  List Red Hat Insights for a Host

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id 
 * @param optional nil or *HostsApiHostsHostsInsightsListOpts - Optional Parameters:
     * @param "Page" (optional.Int32) -  A page number within the paginated result set.
     * @param "PageSize" (optional.Int32) -  Number of results to return per page.
     * @param "Search" (optional.String) -  A search term.
...
type HostsApiHostsHostsInsightsListOpts struct { 
	Page optional.Int32
	PageSize optional.Int32
	Search optional.String
}

func (a *HostsApiService) HostsHostsInsightsList(ctx context.Context, id string, localVarOptionals *HostsApiHostsHostsInsightsListOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
