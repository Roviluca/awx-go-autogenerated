...
/*
JobEventsApiService  List Hosts for a Job Event
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *JobEventsApiJobEventsJobEventsHostsListOpts - Optional Parameters:
     * @param "Page" (optional.Int32) -  A page number within the paginated result set.
     * @param "PageSize" (optional.Int32) -  Number of results to return per page.
     * @param "Search" (optional.String) -  A search term.
...
type JobEventsApiJobEventsJobEventsHostsListOpts struct {
	Page     optional.Int32
	PageSize optional.Int32
	Search   optional.String
}

func (a *JobEventsApiService) JobEventsJobEventsHostsList(ctx context.Context, id string, localVarOptionals *JobEventsApiJobEventsJobEventsHostsListOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
JobEventsApiService  List Job Events
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *JobEventsApiJobEventsJobEventsListOpts - Optional Parameters:
     * @param "Page" (optional.Int32) -  A page number within the paginated result set.
     * @param "PageSize" (optional.Int32) -  Number of results to return per page.
     * @param "Search" (optional.String) -  A search term.
...
type JobEventsApiJobEventsJobEventsListOpts struct {
	Page     optional.Int32
	PageSize optional.Int32
	Search   optional.String
}

func (a *JobEventsApiService) JobEventsJobEventsList(ctx context.Context, localVarOptionals *JobEventsApiJobEventsJobEventsListOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
